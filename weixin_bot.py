...
class WeiXinBot:
    ...
    def __init__(self, config, cache_manager, session_manager) -> None:
        self.config = config
        self.wcf = Wcf(port=config['wx']['port'], debug=config.get('debug',False))
